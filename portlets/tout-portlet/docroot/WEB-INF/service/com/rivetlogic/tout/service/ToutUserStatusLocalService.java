...
/**
 * Provides the local service interface for ToutUserStatus. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ronny.vargas
 * @see ToutUserStatusLocalServiceUtil
...
public interface ToutUserStatusLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ToutUserStatusLocalServiceUtil} to access the Tout Portlet Status by User local service. Add custom service methods to {@link com.rivetlogic.tout.service.impl.ToutUserStatusLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
